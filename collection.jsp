...
<table id="customers">
 ...
 <td> <input type="submit" name="submit" value="collect"></td> 
  ...
  <form>  <td><input type="text" value="raj" name="name"></td>
    ...
    <td><input type="text" value="741852" name="mobile"></td>
    <td><input type="text" value="raj" name="medicine"></td>
    <td> <input type="submit" name="submit" value="collect"></td></form>
  ...
  <form>  <td><input type="text" value="raj" name="name"></td>
    ...
    <td><input type="text" value="raj" name="medicine"></td>
     ...
     <td> <input type="submit" name="submit" value="collect">
    <form>
   </tr>
  <tr>
  <form> <td><input type="text" value="raj" name="name"></td>
...
int i=st.executeUpdate("insert into collect(name,address,email,mobile,medicine)values('"+name+"','"+address+"','"+email+"','"+medecine+"','"+mobile+"')");
